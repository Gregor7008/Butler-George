...
public class Serverinfo implements Command{
	...
	public void perform(SlashCommandInteractionEvent event) {
		...
		String[] titles = AnswerEngine.run.getRaw(guild, event.getUser(), "/commands/utilities/serverinfo:titles").split(",");
	...
	public String getHelp(Guild guild, User user) {
		return AnswerEngine.run.getRaw(guild, user, "/commands/utilities/serverinfo:help");
	}
}