...
public class Inbox implements OperationEventHandler {
	...
	public void execute(OperationEvent event) {
		...
		event.replyEmbeds(LanguageEngine.fetchMessage(guild, user, this, "seltype"))
						  .setActionRow(Button.primary("community", Emoji.fromFormatted(":tada:")),
								  	    Button.primary("suggestion", Emoji.fromFormatted(":bulb:")),
								  	    Button.primary("moderation", Emoji.fromFormatted(":cop:"))).queue();
