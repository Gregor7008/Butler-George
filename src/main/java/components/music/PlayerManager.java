	...
	public void loadAndPlay(SlashCommandInteractionEvent event, String trackURL ) {
		...
		this.audioPlayerManager.loadItemOrdered(musicManager, trackURL, new AudioLoadResultHandler() {
			...
			public void trackLoaded(AudioTrack track) {
				...
				event.replyEmbeds(AnswerEngine.fetchMessage(guild, user, "/components/music/playermanager:track")
			...
			public void playlistLoaded(AudioPlaylist playlist) {
				...
				if (!playlist.isSearchResult()) {
					...
					event.replyEmbeds(AnswerEngine.fetchMessage(guild, user, "/components/music/playermanager:list")
			...
			public void noMatches() {
				event.replyEmbeds(AnswerEngine.fetchMessage(guild, user, "/components/music/playermanager:nomatch").convert()).queue();
			...
			public void loadFailed(FriendlyException exception) {
				event.replyEmbeds(AnswerEngine.fetchMessage(guild, user, "/components/music/playermanager:fail").convert()).queue();
				channel.getGuild().getAudioManager().closeAudioConnection();
