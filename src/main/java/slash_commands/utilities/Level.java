...
public class Level implements SlashCommandEventHandler {
	...
	public File renderLevelcard(User iuser, Guild guild) {
		String levelbackground = String.valueOf(ConfigLoader.INSTANCE.getMemberConfig(guild, iuser).getInt("levelbackground"));
		int level = ConfigLoader.INSTANCE.getMemberConfig(guild, iuser).getInt("level");
		String curxp = String.valueOf(ConfigLoader.INSTANCE.getMemberConfig(guild, iuser).getInt("experience"));
